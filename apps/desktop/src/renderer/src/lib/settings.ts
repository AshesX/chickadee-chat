...
export const store = {
  ...
  getSfxMuteOtherEnabled: (): boolean => cache.sfxMuteOtherEnabled ?? true,
  setSfxMuteOtherEnabled: (sfxMuteOtherEnabled: boolean): void => persist({ sfxMuteOtherEnabled }),
  ...
  getUploadBudgetMbps: (): number => cache.uploadBudgetMbps ?? 12,
  setUploadBudgetMbps: (uploadBudgetMbps: number): void => persist({ uploadBudgetMbps }),
  ...
  getSidebarWidthScale: (): number => cache.sidebarWidthScale ?? 1.0,
  setSidebarWidthScale: (sidebarWidthScale: number): void => persist({ sidebarWidthScale }),
  ...
  getDefaultVideoAction: (): 'camera' | 'screen' => cache.defaultVideoAction ?? 'screen',
