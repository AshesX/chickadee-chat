...
export const store = {
  ...
  getReactionsButtonEnabled: getter('reactionsButtonEnabled'),
  setReactionsButtonEnabled: setter('reactionsButtonEnabled'),
  ...
  getSoundboardButtonEnabled: getter('soundboardButtonEnabled'),
  setSoundboardButtonEnabled: setter('soundboardButtonEnabled'),
  getSoundboardPresetsEnabled: getter('soundboardPresetsEnabled'),
  setSoundboardPresetsEnabled: setter('soundboardPresetsEnabled'),
  getSoundboardCustomEnabled: getter('soundboardCustomEnabled'),
  setSoundboardCustomEnabled: setter('soundboardCustomEnabled'),
};
