...
export const SETTINGS_SEARCH_INDEX: SearchEntry[] = [
  ...
  { label: 'Enable Soundboard', description: 'Hear and play soundboard clips, and turn background sync on or off', tab: 'soundboard', keywords: ['soundboard', 'sounds', 'clips', 'enable', 'disable'] },
  { label: 'Show Soundboard Button', description: 'Show or hide the Soundboard button in the control bar', tab: 'soundboard', keywords: ['soundboard', 'button', 'show', 'hide', 'control bar'] },
  ...
  { label: 'Enable Reactions', description: 'See floating emoji reactions from others and send your own', tab: 'reactions', sectionId: 'section-reactions-emojis', keywords: ['reactions', 'react', 'emoji', 'floating', 'disable', 'hide'] },
  { label: 'Show React Button', description: 'Show or hide the React button in the control bar', tab: 'reactions', sectionId: 'section-reactions-emojis', keywords: ['reactions', 'react', 'button', 'show', 'hide', 'control bar'] },
  { label: 'Theme', description: 'Application color theme', tab: 'ui', keywords: ['theme', 'color', 'light', 'dark', 'blaze', 'orange', 'midnight', 'appearance', 'colours'] },
...
export const SUBSECTIONS: Partial<Record<string, { label: string; id: string }[]>> = {
  ...
  audio: [
    ...
    { label: 'Voice Quality', id: 'section-voice-quality' },
  ],
  video: [
  ...
  chat: [
    { label: 'Chat', id: 'section-chat-settings' },
    { label: 'Emojis', id: 'section-chat-emojis' },
    { label: 'Text-to-Speech', id: 'section-chat-tts' },
    { label: 'Keybindings', id: 'section-chat-keybindings' },
  ],
  reactions: [
    { label: 'Reactions', id: 'section-reactions-emojis' },
  ],
  keybindings: [
...
export const TAB_LABELS: Record<TabId, string> = {
  ...
  sfx: 'Sound Effects', chat: 'Chat', reactions: 'Reactions', ui: 'User Interface',
