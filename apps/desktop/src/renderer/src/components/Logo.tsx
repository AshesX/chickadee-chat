...
export function Logo({ size = 24, className, staticLogo = false }: LogoProps): React.JSX.Element {
  ...
  return (
    ...
    >
      <defs>
        <mask id="chickadee-eye-holes">
          <rect x="-30" y="-10" width="420" height="420" fill="white" />
          <circle cx={EYE_LEFT.cx} cy={EYE_LEFT.cy} r="34.4" fill="black" />
          <circle cx={EYE_RIGHT.cx} cy={EYE_RIGHT.cy} r="34.4" fill="black" />
        </mask>
      </defs>
      <path
        id="chickadee-body"
        mask="url(#chickadee-eye-holes)"
